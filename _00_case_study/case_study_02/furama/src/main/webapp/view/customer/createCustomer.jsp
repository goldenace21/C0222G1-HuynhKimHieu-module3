        ...
        <div class="col-lg-6 mx-auto my-5" >
            <form action="/customer" method="post">
                ...
                <div class="form-group">
                    ...
                    <input required pattern="^(KH-)[\d]{4}$" required pattern="^(KH-)[\d]{4}$" type="text" name="id" placeholder="Enter id" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail">Customer name</label>
                    <input type="text" name="name" placeholder="Enter name" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp">
                </div>
                <div class="form-group">
